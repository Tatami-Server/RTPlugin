package net.kigawa.spigot.rtplugin.util.plugin.all.command;

import net.kigawa.spigot.rtplugin.util.all.Named;
import net.kigawa.spigot.rtplugin.util.plugin.all.PluginBase;
import net.kigawa.spigot.rtplugin.util.plugin.all.message.logger.PluginLogger;
